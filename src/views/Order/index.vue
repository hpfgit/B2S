<template>
	<div>
		<div class="main-right-top clearfix">
			<Cart2 title="预计未来七天回款 (元)"></Cart2>
			<Cart2 title="累计利润 (元)"></Cart2>
			<Cart2 title="净利润率"></Cart2>
			<Cart2 title="涨跌率"></Cart2>
		</div>
                  ...
                  <img :src="check_img" alt v-if="item.is_checked">
						...
						<td class="name clearfix">
							<div class="img-box clearfix">
								<img :src="item.img" alt class="pull-left">
								<div class="pull-left">
									<p>{{item.name}}</p>
									<p class="huohao">{{item.sku_raw}}</p>
								</div>
							</div>
						</td>
						<td class="huo-num">
